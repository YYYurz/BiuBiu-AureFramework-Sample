...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp4(XLua.LuaTable p0, bool p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(XLua.LuaTable p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(int p0, byte[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(float p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(UnityEngine.Events.UnityAction<XLua.LuaTable>))
			{
			    return new UnityEngine.Events.UnityAction<XLua.LuaTable>(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<XLua.LuaTable, bool>))
			{
			    return new UnityEngine.Events.UnityAction<XLua.LuaTable, bool>(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<XLua.LuaTable, int>))
			{
			    return new UnityEngine.Events.UnityAction<XLua.LuaTable, int>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<XLua.LuaTable, float>))
			{
			    return new UnityEngine.Events.UnityAction<XLua.LuaTable, float>(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new System.Action<int, byte[]>(__Gen_Delegate_Imp8);
			}
			...
			{
			    return new System.Action<float, float>(__Gen_Delegate_Imp10);
			}
