...
public struct SoundList : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static SoundList GetRootAsSoundList(ByteBuffer _bb) { return GetRootAsSoundList(_bb, new SoundList()); }
  public static SoundList GetRootAsSoundList(ByteBuffer _bb, SoundList obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public SoundList __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public Sound? Data(int j) { int o = __p.__offset(4); return o != 0 ? (Sound?)(new Sound()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int DataLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<SoundList> CreateSoundList(FlatBufferBuilder builder,
      VectorOffset dataOffset = default(VectorOffset)) {
    builder.StartObject(1);
    SoundList.AddData(builder, dataOffset);
    return SoundList.EndSoundList(builder);
  }

  public static void StartSoundList(FlatBufferBuilder builder) { builder.StartObject(1); }
  public static void AddData(FlatBufferBuilder builder, VectorOffset dataOffset) { builder.AddOffset(0, dataOffset.Value, 0); }
  public static VectorOffset CreateDataVector(FlatBufferBuilder builder, Offset<Sound>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateDataVectorBlock(FlatBufferBuilder builder, Offset<Sound>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartDataVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<SoundList> EndSoundList(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<SoundList>(o);
  }
};
