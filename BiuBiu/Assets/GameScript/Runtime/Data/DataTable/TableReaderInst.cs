...
public class GamePlayTableReader : TableReader<GamePlay, GamePlayList>
{
    public override string TablePath => "Assets/GameAssets/DataTables/bytes/GamePlay.bytes";   
    protected override GamePlay? GetData(GamePlayList dataList, int i)
    {
        return dataList.Data(i);
    }
    protected override int GetDataLength(GamePlayList dataList)
    {
        return dataList.DataLength;
    }
    protected override uint GetKey(GamePlay data)
    {
        return data.Id;
    }
    protected override GamePlayList GetTableDataList(ByteBuffer byteBuffer)
    {
        return GamePlayList.GetRootAsGamePlayList(byteBuffer);
    }
}
