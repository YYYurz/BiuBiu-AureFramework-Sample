...
namespace BiuBiu
{
	...
	public class UIEventTrigger : MonoBehaviour, IPointerClickHandler
	{
		...
		public void AddClickEvent(LuaFunction callBack, LuaTable luaSelf)
		{
			if (callBack == null)
			{
		...
		public void AddClickEvent(LuaFunction callBack, LuaTable luaSelf, bool param)
		{
			if (callBack == null)
			{
				Debug.LogError("UIEventTrigger : Add click event failed, callBack is null.");
		...
		public void AddClickEvent(LuaFunction callBack, LuaTable luaSelf, int param)
		{
			if (callBack == null)
			{
				Debug.LogError("UIEventTrigger : Add click event failed, callBack is null.");
		...
		public void AddClickEvent(LuaFunction callBack, LuaTable luaSelf, float param)
		{
			if (callBack == null)
			{
				Debug.LogError("UIEventTrigger : Add click event failed, callBack is null.");
		...
		public void AddClickEvent(LuaFunction callBack, LuaTable luaSelf, LuaTable param)
		{
			if (callBack == null)
			{
				Debug.LogError("UIEventTrigger : Add click event failed, callBack is null.");
