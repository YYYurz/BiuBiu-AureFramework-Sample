...
function UIWindow_mt:AllowMultiInstance()
...
function UIWindow_mt:PauseCoveredUIForm()
...
function UIWindow.Start(builder) builder:StartObject(7) end
...
function UIWindow.AddAllowMultiInstance(builder, AllowMultiInstance) builder:PrependUint32Slot(3, AllowMultiInstance, 0) end
function UIWindow.AddPauseCoveredUIForm(builder, PauseCoveredUIForm) builder:PrependUint32Slot(4, PauseCoveredUIForm, 0) end
function UIWindow.AddAssetPath(builder, AssetPath) builder:PrependUOffsetTRelativeSlot(5, AssetPath, 0) end
function UIWindow.AddLuaFile(builder, LuaFile) builder:PrependUOffsetTRelativeSlot(6, LuaFile, 0) end
