...
def GamePlayAddPreloadAssets(builder, PreloadAssets): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(PreloadAssets), 0)
